/*! instantsearch.js 1.5.0 | © Algolia Inc. and other contributors; Licensed MIT | github.com/algolia/instantsearch.js */ ! function(e, t) {
  ...
  return function(e) {
    ...
    Q.widgets = {
      ...
      stats: V["default"],
      toggle: q["default"]
    }, Q.version = K["default"], Q.createQueryString = l["default"].url.getQueryStringFromState, t["default"] = Q
  }, function(e, t) {
    "use strict";
    ...
    var l = Object.assign || function(e) {
      ...
      k = function(e) {
        function t(e) {
          ...
          return _.addAlgoliaAgent("instantsearch.js " + S["default"]), y.client = _, y.helper = null, y.indexName = c, y.searchParameters = l({}, h, {
            index: c
            ...
            compileOptions: {}
          }, g && (y._searchFunction = g), y.urlSync = v === !0 ? {} : v, y
        }
        return a(t, e), c(t, [{
          key: "addWidget",
          value: function(e) {
          ...
          value: function() {
            ...
            if (this.urlSync) {
              ...
              this._createURL = t.createURL.bind(t), this._createAbsoluteURL = function(t) {
                return e._createURL(t, {
                  absolute: !0
                })
              }, this._onHistoryChange = t.onHistoryChange.bind(t), this.widgets.push(t)
            } else this._createURL = s, this._createAbsoluteURL = s, this._onHistoryChange = function() {};
            this.searchParameters = this.widgets.reduce(u, this.searchParameters);
            var n = (0, h["default"])(this.client, this.searchParameters.index || this.indexName, this.searchParameters);
            this._searchFunction && (this._originalHelperSearch = n.search.bind(n), n.search = this._wrappedSearch.bind(this)), this.helper = n, this._init(n.state, n), n.on("result", this._render.bind(this, n)), n.search()
          }
        }, {
          key: "_wrappedSearch",
          value: function() {
    ...
    "development" === {
      NODE_ENV: "production"
    }.APP_ENV && n(42).enable("algoliasearch*"), r.version = n(98), r.ua = "Algolia for vanilla JavaScript " + r.version, r.initPlaces = f(r), window.__algolia = {
      debug: n(42),
      algoliasearch: r
    };
    var p = {
    ...
    (function(e, o, i) {
      (function() {
        ...
        function E(e, t) {
          t._state === se ? T(e, t._result) : t._state === ue ? k(e, t._result) : N(t, void 0, function(t) {
            S(e, t)
          }, function(t) {
            k(e, t)
          })
        ...
        function R(e, t, n) {
          t.constructor === e.constructor && n === oe && constructor.resolve === ie ? E(e, t) : n === le ? k(e, le.error) : void 0 === n ? T(e, t) : s(n) ? P(e, t, n) : T(e, t)
        }
        ...
        function T(e, t) {
          e._state === ae && (e._result = t, e._state = se, 0 !== e._subscribers.length && X(j, e))
        }
        ...
        function F(e, t, n, r) {
          var o, i, a, u, l = s(n);
          if (l) {
            if (o = M(n, r), o === ce ? (u = !0, i = o.error, o = null) : a = !0, t === o) return void k(t, C())
          } else o = r, a = !0;
        ...
        function U(e) {
          ...
          var r = this,
            o = new r(b);
          if (!Y(e)) return k(o, new TypeError("You must pass an array to race.")), o;
        ...
        function B(e) {
          this._id = he++, this._state = void 0, this._result = void 0, this._subscribers = [], b !== e && ("function" != typeof e && H(), this instanceof B ? I(this, e) : V())
        }
        ...
        var oe = g,
          ...
          he = 0,
          me = B;
        B.all = fe, B.race = pe, B.resolve = ie, B.reject = de, B._setScheduler = u, B._setAsap = l, B._asap = X, B.prototype = {
          constructor: B,
          then: oe,
          "catch": function(e) {
        ...
        q.prototype._validationError = function() {
          ...
          var r = this.promise;
          r._state === ae && (this._remaining--, e === ue ? k(r, n) : this._result[t] = n), 0 === this._remaining && T(r, this._result)
        ...
        n(12).amd ? (r = function() {
          return ye
        }.call(t, n, t, i), !(void 0 !== r && (i.exports = r))) : "undefined" != typeof i && i.exports ? i.exports = ye : "undefined" != typeof this && (this.ES6Promise = ye), ge()
      }).call(this)
    }).call(t, n(9), function() {
      return this
    }(), n(10)(e))
    ...
    function r(e, t, r) {
      ...
      if (!e) throw new c.AlgoliaSearchError("Please provide an application ID. " + l);
      if (!t) throw new c.AlgoliaSearchError("Please provide an API key. " + l);
      this.applicationID = e, this.apiKey = t;
      var f = [this.applicationID + "-1.algolianet.com", this.applicationID + "-2.algolianet.com", this.applicationID + "-3.algolianet.com"];
      this.hosts = {
        read: [],
        write: []
      }, this.hostIndex = {
      ...
      if (/:$/.test(p) || (p += ":"), "http:" !== r.protocol && "https:" !== r.protocol) throw new c.AlgoliaSearchError("protocol must be `http:` or `https:` (was `" + r.protocol + "`)");
    ...
    r.prototype = {
      ...
      _jsonRequest: function(e) {
        function t(n, s) {
          function p(e) {
            ...
            if (u._useCache && n && a && (a[g] = e.responseText), n) return e.body;
            if (r) return f += 1, v();
            var o = new c.AlgoliaSearchError(e.body && e.body.message);
            return u._promise.reject(o)
          }

          function m(r) {
            return i("error: %s, stack: %s", r.message, r.stack), r instanceof c.AlgoliaSearchError || (r = new c.Unknown(r && r.message, r)), f += 1, r instanceof c.Unknown || r instanceof c.UnparsableJSON || f >= u.hosts[e.hostType].length && (d || !h) ? u._promise.reject(r) : (u.hostIndex[e.hostType] = ++u.hostIndex[e.hostType] % u.hosts[e.hostType].length, r instanceof c.RequestTimeout ? v() : (d || (f = 1 / 0), t(n, s)))
          }

          function v() {
            return u.hostIndex[e.hostType] = ++u.hostIndex[e.hostType] % u.hosts[e.hostType].length, s.timeout = u.requestTimeout * (f + 1), t(n, s)
          }
          var g;
          if (u._useCache && (g = e.url), u._useCache && r && (g += "_body_" + s.body), u._useCache && a && void 0 !== a[g]) return i("serving response from cache"), u._promise.resolve(JSON.parse(a[g]));
          if (f >= u.hosts[e.hostType].length) return !h || d ? (i("could not get any response"), u._promise.reject(new c.AlgoliaSearchError("Cannot connect to the AlgoliaSearch API. Send an email to support@algolia.com to report and resolve the issue. Application id was: " + u.applicationID))) : (i("switching to fallback"), f = 0, s.method = e.fallback.method, s.url = e.fallback.url, s.jsonBody = e.fallback.body, s.jsonBody && (s.body = l(s.jsonBody)), o = u._computeRequestHeaders(), s.timeout = u.requestTimeout * (f + 1), u.hostIndex[e.hostType] = 0, d = !0, t(u._request.fallback, s));
          var y = u.hosts[e.hostType][u.hostIndex[e.hostType]] + s.url,
            b = {
              body: s.body,
              jsonBody: s.jsonBody,
              method: s.method,
          ...
          return i("method: %s, url: %s, headers: %j, timeout: %d", b.method, y, b.headers, b.timeout), n === u._request.fallback && i("using fallback"), n.call(u, y, b).then(p, m)
        }
        ...
        this.apiKey.length > p && void 0 !== e.body && void 0 !== e.body.params ? (e.body.apiKey = this.apiKey, o = this._computeRequestHeaders(!1)) : o = this._computeRequestHeaders(), void 0 !== e.body && (r = l(e.body)), i("request start");
        var m = t(u._request, {
          url: e.url,
          method: e.method,
          body: r,
      ...
      _computeRequestHeaders: function(e) {
        ...
        return e !== !1 && (r["x-algolia-api-key"] = this.apiKey), this.userToken && (r["x-algolia-usertoken"] = this.userToken), this.securityTags && (r["x-algolia-tagfilters"] = this.securityTags), this.extraHeaders && t(this.extraHeaders, function(e) {
          r[e.name] = e.value
        }), r
      }
      ...
      partialUpdateObject: function(e, t, n) {
        1 !== arguments.length && "function" != typeof t || (n = t, t = void 0);
        var r = this,
          o = "/1/indexes/" + encodeURIComponent(r.indexName) + "/" + encodeURIComponent(e.objectID) + "/partial";
    ...
    function r(e) {
      for (var t = u(e), n = t.length, r = n && e.length, l = !!r && s(r) && (i(e) || o(e)), f = -1, p = []; ++f < n;) {
        var d = t[f];
    ...
    function r(e) {
      ...
      var t = e.length;
      t = t && s(t) && (i(e) || o(e)) && t || 0;
      for (var n = e.constructor, r = -1, l = "function" == typeof n && n.prototype === e, f = Array(t), p = t > 0; ++r < t;) f[r] = r + "";
      for (var d in e) p && a(d, t) || "constructor" == d && (l || !c.call(e, d)) || f.push(d);
      return f
    }
    var o = n(33),
      i = n(34),
    ...
    function r(e, t) {
      return function(n, r, i) {
        ...
        var a = "";
        return void 0 !== n && (a += e + "=" + encodeURIComponent(n)), void 0 !== r && (a = this.as._getSearchParams(r, a)), this._search(a, t, i)
      }
    }
    e.exports = r;
    var o = n(14)
    ...
    t = e.exports = n(43), t.log = i, t.formatArgs = o, t.save = a, t.load = s, t.useColors = r, t.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : u(), t.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], t.formatters.j = function(e) {
    ...
    t = e.exports = o, t.coerce = u, t.disable = a, t.enable = i, t.enabled = s, t.humanize = n(44), t.names = [], t.skips = [], t.formatters = {};
    var l, c = 0
  }, function(e, t) {
    function n(e) {
      if (e = "" + e, !(e.length > 1e4)) {
    ...
    function o(e) {
      return i(e, l, "day") || i(e, u, "hour") || i(e, s, "minute") || i(e, a, "second") || e + " ms"
    }
    ...
    function r(e, t, n, h, m, v, g) {
      ...
      if (_) {
        ...
        var w = U.call(e),
          x = w == y;
        if (w != C && w != d && (!x || m)) return I[w] ? l(e, w, t) : m ? e : {};
    ...
    var o = n(47),
      ...
      I = {};
    I[d] = I[h] = I[R] = I[m] = I[v] = I[S] = I[O] = I[T] = I[k] = I[N] = I[_] = I[C] = I[w] = I[P] = I[j] = I[A] = I[M] = I[F] = !0, I[g] = I[y] = I[b] = I[x] = I[E] = !1;
    ...
    function r(e, t, n, r, p, m, v) {
      var g = s(e),
        ...
        b = c,
        _ = c;
      g || (b = h.call(e), b == l ? b = f : b != f && (g = u(e))), y || (_ = h.call(t), _ == l ? _ = f : _ != f && (y = u(t)));
      var C = b == f,
        w = _ == f,
        x = b == _;
      ...
      if (!p) {
        ...
        if (P || E) return n(P ? e.value() : e, E ? t.value() : t, r, p, m, v)
      }
      if (!x) return !1;
      m || (m = []), v || (v = []);
    ...
    var o = n(31),
      ...
      T = {};
    T[_] = T[C] = T[w] = T[x] = T[P] = T[E] = T[R] = T[S] = T[O] = !0, T[a] = T[s] = T[b] = T[u] = T[l] = T[c] = T[f] = T[p] = T[d] = T[h] = T[m] = T[v] = T[g] = T[y] = !1;
    ...
    function r(e, t, n, p, d) {
      ...
      return o(m || t, function(o, a) {
        if (m && (a = o, o = t[a]), l(o)) p || (p = []), d || (d = []), i(e, t, a, r, n, p, d);
        else {
          var s = e[a],
    ...
    function r(e, t, n, r, f, p, d) {
      ...
      var v = e[n],
        ...
        y = void 0 === g;
      y && (g = m, s(m) && (a(m) || l(m)) ? g = a(v) ? v : s(v) ? o(v) : [] : u(m) || i(m) ? g = i(v) ? c(v) : u(v) ? v : {} : y = !1), p.push(m), d.push(g), y ? e[n] = r(g, m, f, p, d) : (g === g ? g !== v : v === v) && (e[n] = g)
    }
    var o = n(47),
      i = n(33),
      a = n(34),
    ...
    e.exports = function(e, t, r, o) {
      ...
      for (var l = 0; u > l; ++l) {
        var c, f, p, d, h = e[l].replace(a, "%20"),
          m = h.indexOf(r);
        m >= 0 ? (c = h.substr(0, m), f = h.substr(m + 1)) : (c = h, f = ""), p = decodeURIComponent(c), d = decodeURIComponent(f), n(i, p) ? Array.isArray(i[p]) ? i[p].push(d) : i[p] = [i[p], d] : i[p] = d
      }
      return i
    }
  }, function(e, t) {
    ...
    function r(e, t, n) {
      function r() {
        t.debug("JSONP: success"), m || f || (m = !0, c || (t.debug("JSONP: Fail. Script loaded but did not call the callback"), s(), n(new o.JSONPScriptFail)))
      }
      ...
      function s() {
        clearTimeout(v), d.onload = null, d.onreadystatechange = null, d.onerror = null, p.removeChild(d);
        try {
      ...
      function u() {
        t.debug("JSONP: Script timeout"), f = !0, s(), n(new o.RequestTimeout)
      }

      function l() {
        t.debug("JSONP: Script error"), m || f || (s(), n(new o.JSONPScriptError))
      }
      ...
      d.onreadystatechange = a, d.onload = r, d.onerror = l, d.async = !0, d.defer = !0, d.src = e, p.appendChild(d)
    }
    e.exports = r;
    var o = n(14),
      i = 0
    ...
    function r(e) {
      return function(t, r, i) {
        var a = n(96);
        i = i && a(i) || {}, i.hosts = i.hosts || ["places-dsn.algolia.net", "places-1.algolianet.com", "places-2.algolianet.com", "places-3.algolianet.com"];
        var s = e(t, r, i),
    ...
    var o = n(100),
      i = n(101),
      a = n(173);
    r.version = n(216), r.AlgoliaSearchHelper = o, r.SearchParameters = i, r.SearchResults = a, r.url = n(206), e.exports = r
  }, function(e, t, n) {
    "use strict";
    ...
    l.inherits(r, c.EventEmitter), r.prototype.search = function() {
    ...
    }, r.getConfigurationFromQueryString = v.getStateFromQueryString, r.getForeignConfigurationInQueryString = v.getUnrecognizedParametersInQueryString, r.prototype.setStateFromQueryString = function(e, t) {
      ...
      return h(this.state.getNumericRefinements(e)) ? this.state.isConjunctiveFacet(e) ? this.state.isFacetRefined(e) : this.state.isDisjunctiveFacet(e) ? this.state.isDisjunctiveFacetRefined(e) : this.state.isHierarchicalFacet(e) ? this.state.isHierarchicalFacetRefined(e) : !1 : !0
      ...
      return p(this.state.getHierarchicalRefinement(e)[0].split(this.state._getHierarchicalFacetSeparator(this.state.getHierarchicalFacetByName(e))), function(e) {
        return m(e)
      })
    }, r.prototype._search = function() {
      var e = this.state,
        t = u._getQueries(e.index, e);
      this.emit("search", e, this.lastResults), this.client.search(t, d(this._handleResponse, this, e, this._queryId++))
    ...
    o.PARAMETERS = i(new o), o._parseNumbers = function(e) {
      ...
      addNumericRefinement: function(e, t, n) {
        ...
        return o[e] = x({}, o[e]), o[e][t] ? (o[e][t] = o[e][t].slice(), o[e][t].push(r)) : o[e][t] = [r], this.setQueryParameters({
          page: 0,
      ...
      _clearNumericRefinements: function(e) {
        return g(e) ? {} : y(e) ? p(this.numericRefinements, e) : b(e) ? f(this.numericRefinements, function(t, n, r) {
          var o = {};
      ...
      toggleHierarchicalFacetRefinement: function(e, t) {
        ...
        return o ? -1 === t.indexOf(n) ? r[e] = [] : r[e] = [t.slice(0, t.lastIndexOf(n))] : r[e] = [t], this.setQueryParameters({
          page: 0,
          hierarchicalFacetsRefinements: w({}, r, this.hierarchicalFacetsRefinements)
        })
      },
      ...
      isNumericRefined: function(e, t, n) {
        ...
        var o = this.numericRefinements[e] && !g(this.numericRefinements[e][t]);
        if (g(n) || !o) return o;
        var i = R(n),
      ...
      getRefinedHierarchicalFacets: function() {
        return a(C(this.hierarchicalFacets, "name"), i(this.hierarchicalFacetsRefinements))
      },
    ...
    function r(e, t, n, l) {
      ...
      for (var c = -1, f = e.length; ++c < f;) {
        var p = e[c];
        u(p) && s(p) && (n || a(p) || i(p)) ? t ? r(p, t, n, l) : o(l, p) : n || (l[l.length] = p)
      }
      return l
    }
    var o = n(121),
    ...
    function n(e, t, n, i) {
      t = n(t);
      for (var s = 0, u = e ? e.length : 0, l = t !== t, c = null === t, f = void 0 === t; u > s;) {
        var p = r((s + u) / 2),
          d = n(e[p]),
          h = void 0 !== d,
          m = d === d;
    ...
    try {
      var o;
      o = "undefined" != typeof window ? window.console && r(window.console.warn, console) : r(console.warn, console);
      var i = function(e) {
        var t = [];
        return function(n) {
    ...
    function r(e, t, n, r, g, y, b, _) {
      ...
      var w = r ? r.length : 0;
      if (w || (t &= ~(d | h), r = g = void 0), w -= g ? g.length : 0, t & h) {
        var x = r,
          P = g;
        r = g = void 0
      }
      ...
      if (E && (l(R, E), t = R[1], _ = R[9]), R[9] = null == _ ? C ? 0 : e.length : v(_ - w, 0) || 0, t == f) var S = i(R[0], R[2]);
      else S = t != d && t != (f | d) || R[4].length ? a.apply(void 0, R) : s.apply(void 0, R);
      var O = E ? o : c;
      return O(S, R)
    }
    var o = n(145),
    ...
    (function(t) {
      function r(e, n, C, w, x, P, E, R, S, O) {
        function T() {
          ...
          var Q = N ? C : this,
            $ = j ? Q[e] : e;
          return R && (v = l(v, R)), k && S < v.length && (v.length = S), this && this !== t && this instanceof T && ($ = I || s(e)), $.apply(Q, v)
        }
        var k = n & b,
          N = n & p,
          j = n & d,
    ...
    function n(e, t, n) {
      for (var o = n.length, i = -1, a = r(e.length - o, 0), s = -1, u = t.length, l = Array(u + a); ++s < u;) l[s] = t[s];
      for (; ++i < o;) l[n[i]] = e[i];
      for (; a--;) l[s++] = e[i++];
      return l
    }
    ...
    function n(e, t, n) {
      for (var o = -1, i = n.length, a = -1, s = r(e.length - i, 0), u = -1, l = t.length, c = Array(s + l); ++a < s;) c[a] = e[a];
    ...
    function r(e) {
      if (u(e) && !s(e) && !(e instanceof o)) {
        ...
        if (f.call(e, "__chain__") && f.call(e, "__wrapped__")) return l(e)
      }
      return new i(e)
    }
    var o = n(154),
    ...
    function n(e, t) {
      for (var n = -1, o = e.length, i = -1, a = []; ++n < o;) e[n] === t && (e[n] = r, a[++i] = n);
      return a
    }
    ...
    (function(t) {
      function r(e, n, r, a) {
        function s() {
          for (var n = -1, o = arguments.length, i = -1, c = a.length, f = Array(c + o); ++i < c;) f[i] = a[i];
    ...
    function r(e, t) {
      var n = e[1],
        ...
        m = n | r,
        v = f > m,
        g = r == f && n == c || r == f && n == p && e[7].length <= t[8] || r == (f | p) && n == c;
      if (!v && !g) return e;
      ...
      return y = t[5], y && (b = e[5], e[5] = b ? a(b, y, t[6]) : o(y), e[6] = b ? s(e[5], d) : o(t[6])), y = t[7], y && (e[7] = o(y)), r & f && (e[8] = null == e[8] ? t[8] : h(e[8], t[8])), null == e[9] && (e[9] = t[9]), e[0] = t[0], e[1] = m, e
    }
    var o = n(47),
      i = n(151),
      a = n(152),
    ...
    function a(e, t) {
      ...
      f(n.facets, function(t, r) {
      ...
      }, this), this.hierarchicalFacets = p(this.hierarchicalFacets), f(a, function(r) {
        var i = t.results[l],
        ...
        f(i.facets, function(t, r) {
          ...
          if (a) {
            ...
            if (-1 === l) return;
            this.hierarchicalFacets[s][l].data = C({}, this.hierarchicalFacets[s][l].data, t)
          } else {
            s = u[r];
            ...
            }, o(this.disjunctiveFacets[s], i.facets_stats, r), e.disjunctiveFacetsRefinements[r] && f(e.disjunctiveFacetsRefinements[r], function(t) {
      ...
      }, this), this.hierarchicalFacets = y(this.hierarchicalFacets, S(e)), this.facets = p(this.facets), this.disjunctiveFacets = p(this.disjunctiveFacets), this._state = e
    }
    ...
    a.prototype.getFacetByName = function(e) {
      ...
      if (x(r.sortBy)) return w(n) ? n.sort(r.sortBy) : u(P(l, r.sortBy), n);
    ...
    function r(e, t, n, r) {
      var p = e ? i(e) : 0;
      return u(p) || (e = c(e), p = e.length), n = "number" != typeof n || r && s(t, n, r) ? 0 : 0 > n ? f(p + n, 0) : n || 0, "string" == typeof e || !a(e) && l(e) ? p >= n && e.indexOf(t, n) > -1 : !!p && o(e, t, n) > -1
    }
    var o = n(103),
      i = n(29),
      a = n(34),
    ...
    var r = n(15),
      ...
      u = {
        ...
        _getDisjunctiveFacetSearchParams: function(e, t, n) {
          ...
          return u ? s.facets = this._getDisjunctiveHierarchicalFacetAttribute(e, u, n) : s.facets = t, o.length > 0 && (s.numericFilters = o), r.length > 0 && (s.facetFilters = r), a(e.getQueryParams(), s)
        },
        ...
        _getFacetFilters: function(e, t, n) {
          ...
          return r(e.facetsRefinements, function(e, t) {
            ...
            if (void 0 !== a) {
              ...
              if (t === i) {
                if (-1 === a.indexOf(c) || !f && n === !0 || f && f.split(c).length === a.split(c).length) return;
                f ? (u = f.split(c).length - 1, a = f) : (u = a.split(c).length - 2, a = a.slice(0, a.lastIndexOf(c))), s = l.attributes[u]
    ...
    (function(e, r) {
      ...
      function u(e, n, r) {
        ...
        if (w(n) && (g = " " + RegExp.prototype.toString.call(n)), P(n) && (g = " " + Date.prototype.toUTCString.call(n)), E(n) && (g = " " + c(n)), 0 === a.length && (!y || 0 == n.length)) return _[0] + g + _[1];
        if (0 > r) return w(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special");
        e.seen.push(n);
        var x;
      ...
      function f(e, t, n, r, o) {
        for (var i = [], a = 0, s = t.length; s > a; ++a) N(t, String(a)) ? i.push(p(e, t, n, r, String(a), !0)) : i.push("");
      ...
      function p(e, t, n, r, o, i) {
        ...
        if (l = Object.getOwnPropertyDescriptor(t, o) || {
            value: t[o]
          }, l.get ? s = l.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : l.set && (s = e.stylize("[Setter]", "special")), N(r, o) || (a = "[" + o + "]"), s || (e.seen.indexOf(l.value) < 0 ? (s = v(n) ? u(e, l.value, null) : u(e, l.value, n - 1), s.indexOf("\n") > -1 && (s = i ? s.split("\n").map(function(e) {
            return "  " + e
          }).join("\n").substr(2) : "\n" + s.split("\n").map(function(e) {
            return "   " + e
      ...
      t.format = function(e) {
        ...
        for (var n = 1, r = arguments, i = r.length, a = String(e).replace(j, function(e) {
          ...
          }), s = r[n]; i > n; s = r[++n]) a += v(s) || !x(s) ? " " + s : " " + o(s);
        return a
      ...
      t.debuglog = function(e) {
        ...
        date: "magenta",
        regexp: "red"
      }, t.isArray = h, t.isBoolean = m, t.isNull = v, t.isNullOrUndefined = g, t.isNumber = y, t.isString = b, t.isSymbol = _, t.isUndefined = C, t.isRegExp = w, t.isObject = x, t.isDate = P, t.isError = E, t.isFunction = R, t.isPrimitive = S, t.isBuffer = n(204);
    ...
    o.stringify = function(e, t, n, i, a, s, u, l) {
      ...
      for (var d = 0, h = f.length; h > d; ++d) {
        var m = f[d];
        a && null === e[m] || (c = Array.isArray(e) ? c.concat(o.stringify(e[m], n(t, m), n, i, a, s, u)) : c.concat(o.stringify(e[m], t + "[" + m + "]", n, i, a, s, u)))
      }
      return c
    }, e.exports = function(e, t) {
      t = t || {};
      ...
      var f;
      f = t.arrayFormat in o.arrayPrefixGenerators ? t.arrayFormat : "indices" in t ? t.indices ? "indices" : "repeat" : "indices";
      var p = o.arrayPrefixGenerators[f];
      n || (n = Object.keys(e)), l && n.sort(l);
      for (var d = 0, h = n.length; h > d; ++d) {
        var m = n[d];
        s && null === e[m] || (c = c.concat(o.stringify(e[m], m, p, a, s, u, r, l)))
      }
      return c.join(i)
    }
  }, function(e, t) {
    ...
    o.parseValues = function(e, t) {
      for (var n = {}, o = e.split(t.delimiter, t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit), i = 0, a = o.length; a > i; ++i) {
        ...
        if (-1 === u) n[r.decode(s)] = "", t.strictNullHandling && (n[r.decode(s)] = null);
          ...
          Object.prototype.hasOwnProperty.call(n, l) ? n[l] = [].concat(n[l]).concat(c) : n[l] = c
        }
      }
      return n
      ...
      E = function() {
        function e(t, n) {
          o(this, e), this.urlUtils = t, this.originalConfig = null, this.timer = i(Date.now()), this.mapping = n.mapping || {}, this.getHistoryState = n.getHistoryState || function() {
            return null
          }, this.threshold = n.threshold || 700, this.trackedParameters = n.trackedParameters || ["query", "attribute:*", "index", "page", "hitsPerPage"]
        }
        return l(e, [{
          key: "getConfiguration",
          value: function(e) {
            this.originalConfig = (0, f["default"])({}, e.index, e).state;
          ...
          value: function(e) {
            var t = this,
              n = e.helper;
            w && (w = !1, this.onHistoryChange(this.onPopState.bind(this, n)), n.on("change", function(e) {
          ...
          value: function(e) {
            ...
            n.is_v = C;
            var r = m["default"].getQueryStringFromState(e.filter(this.trackedParameters), {
              moreAttributes: n,
              mapping: this.mapping
            });
            this.timer() < this.threshold ? this.urlUtils.replaceState(r, {
          ...
          value: function(e, t) {
            var n = t.absolute,
              ...
              i = f["default"].url.getUnrecognizedParametersInQueryString(r, {
                mapping: this.mapping
              });
            i.is_v = C;
            var s = this.urlUtils.createURL(f["default"].url.getQueryStringFromState(o, {
              mapping: this.mapping
            }));
            return n ? a(s) : s
          }
    ...
    function o() {
      ...
      return {
        init: function(e) {
          var t = e.helper,
            n = e.templatesConfig;
          this._clearRefinementsAndSearch = l.clearRefinementsAndSearch.bind(null, t), this._templateProps = (0, l.prepareTemplateProps)({
    ...
    var i = function() {
        ...
        return function(t, n, r, o) {
          ...
          if (1 === a) n.children = o;
            ...
            for (var u = Array(a), l = 0; a > l; l++) u[l] = arguments[l + 3];
            n.children = u
          }
          return {
            $$typeof: e,
    ...
    s.createElement = function(e, t, n) {
      var r, i = {},
        ...
        f = null;
      if (null != t) {
        l = void 0 === t.ref ? null : t.ref, u = void 0 === t.key ? null : "" + t.key, c = void 0 === t.__self ? null : t.__self, f = void 0 === t.__source ? null : t.__source;
      ...
      if (Array.isArray(e))
        ...
        if (y) {
          ...
          if (y !== e.entries)
            ...
            for (; !(b = _.next()).done;) {
              var w = b.value;
              w && (u = w[1], h = v + a(w[0]) + d + o(u, 0), m += s(u, h, n, r))
            }
        } else if ("object" === i) {
          String(e);
          f(!1)
          ...
          if (t.hasOwnProperty(i) && i !== b) {
            ...
            if (r(l, i), x.hasOwnProperty(i)) x[i](e, a);
              ...
              if (p) o.push(i, a), n[i] = a;
                ...
                var h = w[i];
                !c || h !== _.DEFINE_MANY_MERGED && h !== _.DEFINE_MANY ? v(!1) : void 0, h === _.DEFINE_MANY_MERGED ? n[i] = s(n[i], a) : h === _.DEFINE_MANY && (n[i] = u(n[i], a))
              } else n[i] = a
            }
          }
      }
    ...
    var R = {
      createClass: function(e) {
        ...
        t.prototype = new E, t.prototype.constructor = t, t.prototype.__reactAutoBindPairs = [], C.forEach(o.bind(null, t)), o(t, e), t.getDefaultProps && (t.defaultProps = t.getDefaultProps()), t.prototype.render ? void 0 : v(!1);
    ...
    function i(e, t, n) {
      ...
      return t && t._owner && t._owner !== f.current && (s.childOwner = " It was passed a child from " + t._owner.getName() + "."), s
    }
      ...
      i = {
        ...
        injectDOMPropertyConfig: function(e) {
          ...
          for (var f in n) {
            ...
            if (!h.mustUseProperty && h.hasSideEffects ? o(!1) : void 0, h.hasBooleanValue + h.hasNumericValue + h.hasOverloadedBooleanValue <= 1 ? void 0 : o(!1), u.hasOwnProperty(f)) {
              var m = u[f];
              h.attributeName = m
            }
    ...
    function r() {
      if (!w) {
        w = !0, g.EventEmitter.injectReactEventListener(v), g.EventPluginHub.injectEventPluginOrder(a), g.EventPluginUtils.injectComponentTree(f), g.EventPluginUtils.injectTreeTraversal(d), g.EventPluginHub.injectEventPluginsByName({
          SimpleEventPlugin: C,
    ...
    function l(e, t, n, r) {
      var o, l;
      if (w ? o = i(e) : N ? s(e, n) && (o = T.compositionEnd) : a(e, n) && (o = T.compositionStart), !o) return null;
      E && (N || o !== T.compositionStart ? o === T.compositionEnd && N && (l = N.getData()) : N = v.getPooled(r));
    ...
    var r = n(265),
      ...
      h = {
        ...
        processEventQueue: function(e) {
          var t = c;
          c = null, e ? s(t, p) : s(t, d), c ? u(!1) : void 0, i.rethrowCaughtError()
        },
        __purge: function() {
          l = {}
        },
    ...
    function c(e) {
      var t = e._dispatchListeners,
        n = e._dispatchInstances;
      Array.isArray(t) ? v(!1) : void 0, e.currentTarget = b.getNodeFromInstance(n);
      var r = t ? t(e) : null;
    ...
    function c(e, t) {
      N = e, j = t, A = e.value, M = Object.getOwnPropertyDescriptor(e.constructor.prototype, "value"), Object.defineProperty(N, "value", D), N.attachEvent ? N.attachEvent("onpropertychange", p) : N.addEventListener("propertychange", p, !1)
    }

    function f() {
      N && (delete N.value, N.detachEvent ? N.detachEvent("onpropertychange", p) : N.removeEventListener("propertychange", p, !1), N = null, j = null, A = null, M = null)
    }
    ...
    function m(e, t) {
      return e !== T.topSelectionChange && e !== T.topKeyUp && e !== T.topKeyDown || !N || N.value === A ? void 0 : (A = N.value, j)
    }
    ...
    var y = n(262),
      ...
      M = null,
      F = !1;
    C.canUseDOM && (F = R("change") && (!("documentMode" in document) || document.documentMode > 8));
    var I = !1;
    C.canUseDOM && (I = R("input") && (!("documentMode" in document) || document.documentMode > 11));
    var D = {
        get: function() {
      ...
      U = {
        ...
        extractEvents: function(e, t, n, o) {
          ...
          if (r(s) ? F ? i = u : a = l : S(s) ? I ? i = d : (i = m, a = h) : v(s) && (i = g), i) {
            var c = i(e, t);
            if (c) {
    ...
    function s(e) {
      ...
      for (var n = 0; t > n; n++) {
        ...
        if (m.performUpdateIfNecessary(r, e.reconcileTransaction), i && console.timeEnd(i), o)
          for (var u = 0; u < o.length; u++) e.callbackQueue.enqueue(o[u], r.getPublicInstance())
      }
    }

    function u(e) {
      return r(), C.isBatchingUpdates ? void y.push(e) : void C.batchedUpdates(u, e)
    }
    ...
    var R = {
        ...
        injectBatchingStrategy: function(e) {
          e ? void 0 : g(!1), "function" != typeof e.batchedUpdates ? g(!1) : void 0, "boolean" != typeof e.isBatchingUpdates ? g(!1) : void 0, C = e
        }
      },
      S = {
    ...
    var r = n(262),
      ...
      c = {
        ...
        extractEvents: function(e, t, n, r) {
          ...
          return g.type = "mouseenter", g.target = m, g.relatedTarget = h, o.accumulateEnterLeaveDispatches(v, g, f, p), [v, g]
        }
      };
    e.exports = c
  }, function(e, t, n) {
          ...
          for (t in n)
            if (n.hasOwnProperty(t)) {
              ...
              for (h in m)
                ...
                var b = g[y];
                b.hasAttribute && b.hasAttribute(f) && (h = +b.getAttribute(f), b.removeAttribute(f), p.hasOwnProperty(h) ? l(!1) : void 0, p[h] = b, d += 1)
              }
    ...
    function r(e, t) {
      t && (z[e._tag] && (null != t.children || null != t.dangerouslySetInnerHTML ? M(!1) : void 0), null != t.dangerouslySetInnerHTML && (null != t.children ? M(!1) : void 0, "object" == typeof t.dangerouslySetInnerHTML && q in t.dangerouslySetInnerHTML ? void 0 : M(!1)), null != t.style && "object" != typeof t.style ? M(!1) : void 0)
    }
    ...
    function s() {
      ...
      switch (t ? void 0 : M(!1), e._tag) {
        ...
        case "audio":
          ...
          for (var n in K) K.hasOwnProperty(n) && e._wrapperState.listeners.push(w.trapBubbledEvent(b.topLevelTypes[n], K[n], t));
          break;
        case "img":
    ...
    f.displayName = "ReactDOMComponent", f.Mixin = {
        ...
        if (e.useCreateElement) {
          ...
          if (u === v.html)
            if ("script" === this._tag) {
              ...
              h.innerHTML = "<" + g + "></" + g + ">", f = h.removeChild(h.firstChild)
            } else f = p.createElement(this._currentElement.type);
          else f = p.createElementNS(u, this._currentElement.type);
          R.precacheNode(this, f), this._flags |= I.hasCachedChildNodes, this._nativeParent || y.setAttributeForRoot(f), this._updateDOMProperties(null, i, e);
          var b = m(f);
          ...
          c = !C && Q[this._tag] ? _ + "/>" : _ + ">" + C + "</" + this._currentElement.type + ">"
        }
        switch (this._tag) {
          case "button":
          case "input":
          ...
          if (t.hasOwnProperty(r)) {
            ...
            if (null != i)
              if (H.hasOwnProperty(r)) i && o(this, r, i, e);
                ...
                r === B && (i && (i = this._previousStyleCopy = p({}, t.style)), i = h.createMarkupForStyles(i, this));
                var a = null;
                null != this._tag && c(this._tag, t) ? W.hasOwnProperty(r) || (a = y.createMarkupForCustomAttribute(r, i)) : a = y.createMarkupForProperty(r, i), a && (n += " " + a)
              }
      ...
      _updateDOMProperties: function(e, t, n) {
        ...
        for (r in e)
          if (!t.hasOwnProperty(r) && e.hasOwnProperty(r) && null != e[r])
            ...
            } else H.hasOwnProperty(r) ? e[r] && D(this, r) : (g.properties[r] || g.isCustomAttribute(r)) && y.deleteValueForProperty(U(this), r);
        for (r in t) {
          var u = t[r],
          ...
          if (t.hasOwnProperty(r) && u !== l && (null != u || null != l))
            ...
            var f = U(this);
            null != u ? y.setValueForProperty(f, r, u) : y.deleteValueForProperty(f, r)
          }
        }
      ...
      unmountComponent: function(e) {
        ...
        this.unmountChildren(e), R.uncacheNode(this), _.deleteAllListeners(this), x.unmountIDFromEnvironment(this._rootNodeID), this._rootNodeID = null, this._domID = null, this._wrapperState = null
      },
    ...
    function o(e) {
      ...
      if ("radio" === t.type && null != o) {
        ...
        for (var f = a.querySelectorAll("input[name=" + JSON.stringify("" + o) + '][type="radio"]'), p = 0; p < f.length; p++) {
          var d = f[p];
      ...
      v = {
        Mixin: {
            ...
            if (i || r) {
              ...
              for (a in i)
                if (i.hasOwnProperty(a)) {
                  var h = r && r[a],
                    m = i[a];
                  h === m ? (s = u(s, this.moveChild(h, d, f, c)), c = Math.max(h._mountIndex, c), h._mountIndex = f) : (h && (c = Math.max(h._mountIndex, c)), s = u(s, this._mountChildAtIndex(m, d, f, t, n))), f++, d = p.getNativeNode(m)
          ...
          _mountChildAtIndex: function(e, t, n, r, o) {
            var i = p.mountComponent(e, r, this, this._nativeContainerInfo, o);
            ...
            for (u in t)
              if (t.hasOwnProperty(u)) {
                ...
                var c = l && l._currentElement,
                  f = t[u];
                if (null != l && a(c, f)) o.receiveComponent(l, f, r, s), t[u] = l;
                else {
    ...
    var _ = 1,
      C = {
        ...
        mountComponent: function(e, t, n, r) {
          ...
          a.props = u, a.context = c, a.refs = g, a.updater = v, this._instance = a, f.set(a, this);
          var d = a.state;
        ...
        performInitialMount: function(e, t, n, r, o) {
          ...
          i.componentWillMount && (i.componentWillMount(), this._pendingStateQueue && (i.state = this._processPendingState(i.props, i.context))), void 0 === e && (e = this._renderValidatedComponent()), this._renderedNodeType = p.getType(e), this._renderedComponent = this._instantiateReactComponent(e);
        ...
        _updateRenderedComponent: function(e, t) {
          ...
          if (b(r, o)) m.receiveComponent(n, o, e, this._processChildContext(t));
            ...
            m.unmountComponent(n, !1), this._renderedNodeType = p.getType(o), this._renderedComponent = this._instantiateReactComponent(o);
    ...
    r(c.prototype, {
      mountComponent: function(e, t, n, r) {
        ...
        if (this._domID = o, this._nativeParent = t, e.useCreateElement) {
          ...
          return i.queueChild(d, i(f)), this._stringText && i.queueChild(d, i(c.createTextNode(this._stringText))), i.queueChild(d, i(p)), a.precacheNode(this, f), this._closingComment = p, d
        }
    ...
    var i = n(262),
      ...
      P = {
        ...
        extractEvents: function(e, t, n, r) {
          ...
          switch (e) {
            case m.topFocus:
              (p(i) || "true" === i.contentEditable) && (y = i, b = t, _ = null);
              break;
            case m.topBlur:
    ...
    var U = {
      ...
      _renderNewRootComponent: function(e, t, n, r) {
        !t || t.nodeType !== j && t.nodeType !== A && t.nodeType !== M ? S(!1) : void 0, h.ensureScrollValueMonitoring();
        var o = R(e);
      ...
      renderSubtreeIntoContainer: function(e, t, n, r) {
        return null == e || null == e._reactInternalInstance ? S(!1) : void 0, U._renderSubtreeIntoContainer(e, t, n, r)
      },
      _renderSubtreeIntoContainer: function(e, t, n, r) {
        x.validateCallback(r, "ReactDOM.render"), y.isValidElement(t) ? void 0 : S(!1);
      ...
      unmountComponentAtNode: function(e) {
        !e || e.nodeType !== j && e.nodeType !== A && e.nodeType !== M ? S(!1) : void 0;
        var t = f(e);
        if (!t) {
          l(e), 1 === e.nodeType && e.hasAttribute(N);
          return !1
        }
        return delete F[t._instance.rootID], P.batchedUpdates(u, t, e, !1), !0
      },
      _mountImageIntoNode: function(e, t, n, i, a) {
        if (!t || t.nodeType !== j && t.nodeType !== A && t.nodeType !== M ? S(!1) : void 0, i) {
          var s = o(t);
          if (_.canReuseMarkup(e, s)) return void m.precacheNode(n, s);
    ...
    function c() {
      var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0],
        ...
        n = (0, k["default"])([].concat(o((0, O["default"])(e)), o((0, O["default"])(t))));
    ...
    function f(e, t, n, r, o) {
      ...
      if ("hierarchical" === t) {
        ...
        i.name = l[l.length - 1];
        for (var c = 0; void 0 !== a && c < l.length; ++c) a = (0, w["default"])(a.data, {
          name: l[c]
        });
    ...
    function p(e, t) {
      ...
      }), (0, _["default"])(t.disjunctiveFacetsRefinements, function(r, o) {
        (0, _["default"])(r, function(r) {
          n.push(f(t, "disjunctive", o, r, e.disjunctiveFacets))
        })
      }), (0, _["default"])(t.hierarchicalFacetsRefinements, function(r, o) {
        (0, _["default"])(r, function(r) {
    ...
    function d(e, t) {
      return (0, R["default"])(t) ? (e = e.clearTags(), e = e.clearRefinements()) : ((0, _["default"])(t, function(t) {
    ...
    Object.defineProperty(t, "__esModule", {
      value: !0
    }), t.prefixKeys = t.clearRefinementsAndSearch = t.clearRefinementsFromState = t.getRefinements = t.isDomElement = t.isSpecialClick = t.prepareTemplateProps = t.bemHelper = t.getContainerNode = void 0;
    var v = Object.assign || function(e) {
      ...
      N = n(213),
      j = r(N);
    t.getContainerNode = i, t.bemHelper = u, t.prepareTemplateProps = l, t.isSpecialClick = s, t.isDomElement = a, t.getRefinements = p, t.clearRefinementsFromState = d, t.clearRefinementsAndSearch = h, t.prefixKeys = m
  }, function(e, t, n) {
    function r(e, t, n) {
    ...
    function s(e) {
      var t = function(t) {
        ...
        return a(n, t), u(n, [{
          ...
          value: function(e) {
            this.props.shouldAutoHideContainer !== e.shouldAutoHideContainer && this._hideOrShowContainer(e)
          }
        }, {
      ...
      var t = function(t) {
        function n(e) {
          ...
          return t.handleHeaderClick = t.handleHeaderClick.bind(t), t.state = {
            ...
            type: "header",
            handleClick: e.collapsible ? t.handleHeaderClick : null
          }), t._cssClasses = {
        ...
        return a(n, t), c(n, [{
          ...
          value: function(e) {
            ...
            return p["default"].createElement(v["default"], l({}, this.props.templateProps, {
              rootProps: {
                className: i,
                onClick: r
              },
          ...
          value: function() {
            ...
            return u("div", {
              ...
              className: n.body
            }, void 0, p["default"].createElement(e, this.props)), this._footerElement)
          }
        }]), n
      }(p["default"].Component);
          ...
          value: function() {
            var e = this.props.useCustomCompileOptions[this.props.templateKey],
              ...
              n = u({
                ...
                data: s(this.props.transformData, this.props.templateKey, this.props.data)
              });
    ...
    ! function(e) {
      ...
      function o(t, n, r, s) {
        ...
        for (c = r[r.length - 1]; t.length > 0;) {
          if (f = t.shift(), c && "<" == c.tag && !(f.tag in C)) throw new Error("Illegal content in < super tag.");
      ...
      e.tags = {
        ...
        var c = o.length,
          ...
          x = "{{",
          P = "}}";
        for (i && (i = i.split(" "), x = i[0], P = i[1]), C = 0; c > C; C++) m == f ? r(x, o, C) ? (--C, a(), m = p) : "\n" == o.charAt(C) ? u(_) : y += o.charAt(C) : m == p ? (C += x.length - 1, g = e.tags[o.charAt(C + 1)], v = g ? o.charAt(C + 1) : "_v", "=" == v ? (C = l(o, C), m = f) : (g && C++, m = d), _ = C) : r(P, o, C) ? (b.push({
          tag: v,
          n: n(y),
          otag: x,
          ctag: P,
          i: "/" == v ? _ - x.length : C + P.length
        }), y = "", C += P.length - 1, m = f, "{" == v && ("}}" == P ? C++ : t(b[b.length - 1]))) : y += o.charAt(C);
        return u(_, !0), b
      };
      var C = {
        _t: !0,
    ...
    ! function(e) {
      ...
      e.Template = function(e, t, n, r) {
        ...
        s: function(e, t, n, r, o, i, a) {
          var s;
          return f(e) && 0 === e.length ? !1 : ("function" == typeof e && (e = this.ms(e, t, n, r, o, i, a)), s = !!e, !r && s && t && t.push("object" == typeof e ? e : t[t.length - 1]), s)
        },
        d: function(e, n, r, o) {
          var i, a = e.split("."),
            s = this.f(a[0], n, r, o),
          ...
          if ("." === e && f(n[n.length - 2])) s = n[n.length - 1];
            ...
            for (var c = 1; c < a.length; c++) i = t(a[c], s, u), void 0 !== i ? (l = s, s = i) : s = "";
          return o && !s ? !1 : (o || "function" != typeof s || (n.push(l), s = this.mv(s, n, r), n.pop()), s)
        },
        f: function(e, n, r, o) {
          for (var i = !1, a = null, s = !1, u = this.options.modelGet, l = n.length - 1; l >= 0; l--)
    ...
    var s = Object.assign || function(e) {
      ...
      m = function(e) {
        ...
        return a(t, e), l(t, [{
          ...
          key: "handleClick",
          value: function(e) {
            (0, h.isSpecialClick)(e) || (e.preventDefault(), this.props.clearAll())
          }
        }, {
          key: "render",
          value: function() {
            ...
            }, void 0, f["default"].createElement(d["default"], s({
              data: e,
              templateKey: "link"
    ...
    function o(e) {
      var t = e.container,
        ...
        S = e.cssClasses,
        T = void 0 === S ? {} : S,
        k = (0, P["default"])(r) && (0, M["default"])(r, function(e, t) {
          return e && (0, R["default"])(t) && (0, w["default"])(t.name) && ((0, y["default"])(t.label) || (0, w["default"])(t.label)) && ((0, y["default"])(t.template) || (0, w["default"])(t.template) || (0, O["default"])(t.template)) && ((0, y["default"])(t.transformData) || (0, O["default"])(t.transformData))
        }, !0),
        N = ["header", "item", "clearAll", "footer"],
        A = (0, R["default"])(m) && (0, M["default"])(m, function(e, t, n) {
          return e && -1 !== N.indexOf(n) && ((0, w["default"])(t) || (0, O["default"])(t))
        }, !0),
        F = ["root", "header", "body", "clearAll", "list", "item", "link", "count", "footer"],
        I = (0, R["default"])(T) && (0, M["default"])(T, function(e, t, n) {
          return e && -1 !== F.indexOf(n) && (0, w["default"])(t) || (0, P["default"])(t)
        }, !0),
        D = !(((0, w["default"])(t) || (0, h.isDomElement)(t)) && (0, P["default"])(r) && k && (0, _["default"])(i) && -1 !== [!1, "before", "after"].indexOf(f) && (0, R["default"])(m) && A && ((0, y["default"])(C) || (0, O["default"])(C)) && (0, _["default"])(E) && I);
      ...
      return {
        init: function(e) {
          var t = e.helper;
          this._clearRefinementsAndSearch = h.clearRefinementsAndSearch.bind(null, t, $)
        },
        render: function(e) {
          var t = e.results,
            n = e.helper,
      ...
      P = function(e) {
        ...
        return a(t, e), p(t, [{
          ...
          value: function(e, t) {
            ...
            }, void 0, h["default"].createElement(v["default"], c({
          ...
          value: function(e, t) {
            ...
            return f("div", {
              ...
              onClick: l(this.props.clearRefinementClicks[t])
            }, void 0, h["default"].createElement(v["default"], c({
              data: r,
              templateKey: "item"
          ...
          key: "render",
          value: function() {
            return f("div", {}, void 0, this._clearAllElement("before", this.props.clearAllPosition), f("div", {
              className: this.props.cssClasses.list
            }, void 0, (0, b["default"])(this.props.refinements, this._refinementElement, this)), this._clearAllElement("after", this.props.clearAllPosition))
          }
        }]), t
      }(h["default"].Component);
    t["default"] = P
    ...
    function o() {
      ...
      return {
        ...
        render: function(e) {
          ...
          a = this._prepareFacetValues(a, r), u["default"].render(i(A, {
    ...
    var u = function() {
      ...
      w = function(e) {
        ...
        return s(t, e), c(t, [{
          key: "shouldComponentUpdate",
          value: function(e, t) {
            return t !== this.state || !(0, C["default"])(this.props.facetValues, e.facetValues)
          }
        }, {
          key: "refine",
          value: function(e, t) {
          ...
          value: function(e) {
            ...
            r && (n = p["default"].createElement(t, l({}, this.props, {
              depth: this.props.depth + 1,
              facetValues: e.data
            })));
            var i = this.props.createURL(e[this.props.attributeNameKey]),
              a = l({}, e, {
                url: i,
            ...
            return void 0 !== e.isRefined && (c += "/" + e.isRefined), void 0 !== e.count && (c += "/" + e.count), u(b["default"], {
          ...
          value: function() {
            ...
            this.props.cssClasses.depth && e.push("" + this.props.cssClasses.depth + this.props.depth);
            var t = this.state.isShowMoreOpen ? this.props.limitMax : this.props.limitMin,
              ...
              o = r ? p["default"].createElement(g["default"], l({
                rootProps: {
            ...
            }, void 0, n.map(this._generateFacetItem, this), o)
          }
        }]), t
      }(p["default"].Component);
    w.defaultProps = {
    ...
    function o() {
      ...
      if (a.item && a.allItems) throw new Error("Must contain only allItems OR item template." + g);
    ...
    var s = function() {
      ...
      _ = function(e) {
        ...
        return a(t, e), l(t, [{
          key: "shouldComponentUpdate",
          value: function(e) {
            return 0 === this.props.results.hits.length || this.props.results.hits.length !== e.results.hits.length || !(0, g["default"])(this.props.results.hits, e.results.hits)
          }
        }, {
          key: "renderWithResults",
          value: function() {
            var e = this,
              t = (0, d["default"])(this.props.results.hits, function(t) {
          ...
          value: function() {
            return f["default"].createElement(m["default"], u({
              data: this.props.results,
              rootProps: {
                className: (0, b["default"])(this.props.cssClasses.root, this.props.cssClasses.empty)
              },
              templateKey: "empty"
            }, this.props.templateProps))
          }
    ...
    function o() {
      ...
      return {
        init: function(e) {
          ...
          o || (void 0 === r.hitsPerPage ? window.console && window.console.log("[Warning][hitsPerPageSelector] hitsPerPage not defined. You should probably used a `hits` widget or set the value `hitsPerPage` using the searchParameters attribute of the instantsearch constructor.") : window.console && window.console.log("[Warning][hitsPerPageSelector] No option in `options` with `value: hitsPerPage` (hitsPerPage: " + r.hitsPerPage + ")"), n = [{
            value: void 0,
            label: ""
    ...
    function o() {
      var e = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0],
        ...
        T = void 0 === O ? !1 : O,
        k = (0, y["default"])(T);
      if (k && k.limit < u) throw new Error("showMore.limit configuration should be > than the limit in the main configuration");
      var N = k && k.limit || u;
      ...
      return {
        ...
        render: function(e) {
          ...
          c = this._prepareFacetValues(c, a), l["default"].render(i(A, {
            collapsible: C,
            createURL: t,
            cssClasses: D,
            facetValues: c,
    ...
    function i(e) {
      var t = e.container,
        ...
        j = void 0 === N ? !1 : N,
        A = (0, b["default"])(j);
      if (A && A.limit < h) throw new Error("showMore.limit configuration should be > than the limit in the main configuration");
      var M = A && A.limit || h,
        F = x["default"];
      if (!t || !n) throw new Error(E);
      F = (0, g["default"])(F), k === !0 && (F = (0, m["default"])(F));
      var I = (0, f.getContainerNode)(t);
      if (i && (i = i.toLowerCase(), "and" !== i && "or" !== i)) throw new Error(E);
      ...
      return {
        ...
        render: function(e) {
          ...
          var o = e.results,
            ...
            l = e.createURL,
            c = r.map(function(e) {
              return e.isRefined = i(s, n, e), e.attributeName = n, e
            });
    ...
    function o(e) {
      var t = e.container,
        ...
        _ = g["default"];
      if (h === !0 && (_ = (0, m["default"])(_)), !t || !a || 0 === a.length || !o) throw new Error(b);
      var C = {
      ...
      return {
        init: function(e) {
          ...
          void 0 !== n && t.addNumericRefinement(o, r, n), this._refine = function(e) {
            t.clearRefinements(o), void 0 !== e && t.addNumericRefinement(o, r, e), t.search()
          }
        },
        render: function(e) {
          var t = e.helper,
    ...
    var s = function() {
      ...
      w = function(e) {
        function t(e) {
          o(this, t);
          var n = i(this, Object.getPrototypeOf(t).call(this, (0, h["default"])(e, t.defaultProps)));
        ...
        return a(t, e), u(t, [{
          ...
          value: function(e) {
            var t = e.label,
              ...
              f = e.createURL,
              p = {
                item: (0, C["default"])(this.props.cssClasses.item, i),
                link: (0, C["default"])(this.props.cssClasses.link)
              };
            u ? p.item = (0, C["default"])(p.item, this.props.cssClasses.disabled) : c && (p.item = (0, C["default"])(p.item, this.props.cssClasses.active));
            var d = f && !u ? f(r) : "#";
            return s(b["default"], {
              ariaLabel: n,
              cssClasses: p,
          ...
          value: function() {
            ...
            return s("ul", {
              className: this.props.cssClasses.root
            }, void 0, this.props.showFirstLast ? this.firstPageLink(e, t) : null, this.previousPageLink(e, t), this.pages(e, t), this.nextPageLink(e, t), this.props.showFirstLast ? this.lastPageLink(e, t) : null)
          }
        }]), t
      }(c["default"].Component);
    w.defaultProps = {
    ...
    function o() {
      ...
      return void 0 !== g.currency && g.currency !== C && (C = g.currency), {
        getConfiguration: function() {
          return {
            facets: [n]
          }
        ...
        _extractRefinedRange: function(e) {
          ...
          return 0 === t.length ? [] : (t.forEach(function(e) {
            -1 !== e.operator.indexOf(">") ? r = Math.floor(e.value[0]) : -1 !== e.operator.indexOf("<") && (o = Math.ceil(e.value[0]))
          }), [{
            from: r,
            to: o,
            isRefined: !0
        ...
        _refine: function(e, t, r) {
          ...
          e.clearRefinements(n), 0 !== o.length && o[0].from === t && o[0].to === r || ("undefined" != typeof t && e.addNumericRefinement(n, ">=", Math.floor(t)), "undefined" != typeof r && e.addNumericRefinement(n, "<=", Math.ceil(r))), e.search()
        },
        init: function(e) {
          var t = e.helper,
            n = e.templatesConfig;
          this._refine = this._refine.bind(this, t), this._templateProps = (0, c.prepareTemplateProps)({
        ...
        render: function(e) {
          var t = e.results,
            ...
            a = e.createURL,
            s = void 0;
          t.hits.length > 0 ? (s = this._extractRefinedRange(r), 0 === s.length && (s = this._generateRanges(t))) : s = [], s.map(function(e) {
            var t = o.clearRefinements(n);
            return e.isRefined || (void 0 !== e.from && (t = t.addNumericRefinement(n, ">=", Math.floor(e.from))), void 0 !== e.to && (t = t.addNumericRefinement(n, "<=", Math.ceil(e.to)))), e.url = a(t), e
    ...
    function r(e) {
      ...
      if (o !== i) {
        for (a = o, u.push({
            to: a
          }); r > a;) s = u[u.length - 1].to, a = n(s + (r - o) / 3, t), s >= a && (a = s + 1), u.push({
          from: s,
          to: a
        });
    ...
    var u = function() {
      ...
      C = function(e) {
        ...
        return s(t, e), c(t, [{
          key: "componentWillMount",
          value: function() {
            this.refine = this.refine.bind(this), this.form = this.getForm()
          }
        }, {
          key: "shouldComponentUpdate",
          value: function(e) {
          ...
          value: function(e) {
            var t = (0, y["default"])(this.props.cssClasses.item, o({}, this.props.cssClasses.active, e.isRefined)),
              n = e.from + "_" + e.to,
            ...
            return u("div", {
              ...
              href: e.url,
              onClick: r
            }, void 0, p["default"].createElement(h["default"], l({
              data: i,
              templateKey: "item"
            }, this.props.templateProps))))
          }
          ...
          value: function() {
            ...
            return u("div", {}, void 0, u("div", {
              className: this.props.cssClasses.list
            }, void 0, this.props.facetValues.map(function(t) {
      ...
      f = function(e) {
        ...
        return a(t, e), u(t, [{
          ...
          value: function(e) {
            ...
            }, void 0, this.props.labels.currency, " "), c["default"].createElement("input", {
          ...
          value: function() {
            ...
            }, void 0, " ", this.props.labels.separator, " "), t, s("button", {
    ...
    function o(e) {
      ...
      return t = (0, d.getContainerNode)(t), "boolean" != typeof P && (P = "auto"), {
        getInput: function() {
        ...
        init: function(e) {
          function n(e) {
            return e !== a.state.query ? S ? void S(e, r) : void r(e) : void 0
          }
          ...
          if (this.addDefaultAttributesToInput(p, o.query), R ? i(p, "keyup", s(C, u(n))) : (i(p, O, u(n)), ("propertychange" === O || window.attachEvent) && i(p, "keyup", s(w, u(n)))), c) {
          ...
          f && this.addPoweredBy(p), l(function(e) {
            p.value = e.query || ""
          }), (P === !0 || "auto" === P && "" === a.state.query) && p.focus()
        },
        render: function(e) {
          var t = e.helper;
    ...
    function i() {
      ...
      return {
        getConfiguration: function(e) {
          ...
          return void 0 === T && void 0 === k || e && (!e.numericRefinements || void 0 !== e.numericRefinements[n]) || (t.numericRefinements = o({}, n, {}), void 0 !== T && (t.numericRefinements[n][">="] = [T]), void 0 !== k && (t.numericRefinements[n]["<="] = [k])), t
        },
        ...
        _refine: function(e, t, r) {
          e.clearRefinements(n), r[0] > t.min && e.addNumericRefinement(n, ">=", r[0]), r[1] < t.max && e.addNumericRefinement(n, "<=", r[1]), e.search()
        },
        init: function(e) {
          var t = e.templatesConfig;
          this._templateProps = (0, c.prepareTemplateProps)({
        ...
        render: function(e) {
          var t = e.results,
            ...
            s = void 0;
          void 0 !== T || void 0 !== k ? (s = {}, void 0 !== T && (s.min = T), void 0 !== k && (s.max = k)) : s = void 0 !== o && void 0 !== o.stats ? o.stats : {
            min: null,
            max: null
          };
    ...
    var s = Object.assign || function(e) {
      ...
      v = function(e) {
        ...
        return a(t, e), u(t, [{
          ...
          key: "shouldComponentUpdate",
          value: function(e) {
            return !(0, h["default"])(this.props.range, e.range) || !(0, h["default"])(this.props.start, e.start)
          }
        }, {
          key: "handleChange",
          value: function(e, t, n) {
          ...
          key: "render",
          value: function() {
            if (this.props.range.min === this.props.range.max) return null;
            var e = void 0;
            ...
            } : this.props.pips, c["default"].createElement(p["default"], s({}, this.props, {
              animate: !1,
              behaviour: "snap",
              connect: !0,
              cssPrefix: m,
    ...
    d.propTypes = {
      ...
      tooltips: c["default"].PropTypes.oneOfType([c["default"].PropTypes.bool, c["default"].PropTypes.arrayOf(c["default"].PropTypes.shape({
    ...
    ! function(n) {
      ...
      function C(e, t, n) {
        ...
        var r, o, i, a, s = _(n, e);
        return r = e[s - 1], o = e[s], i = t[s - 1], a = t[s], i + y([r, o], n) / v(i, a)
      }

      function w(e, t, n) {
        if (n >= 100) return e.slice(-1)[0];
        var r, o, i, a, s = _(n, t);
        return r = e[s - 1], o = e[s], i = t[s - 1], a = t[s], b([r, o], (n - i) * v(i, a))
      }
      ...
      function E(e, t, n) {
        return t ? void(n.xSteps[e] = g([n.xVal[e], n.xVal[e + 1]], t) / v(n.xPct[e], n.xPct[e + 1])) : !0
      }
      ...
      function B(t, r) {
        ...
        function v(e, t) {
          ...
          var n, r, o = 0 === e.type.indexOf("touch"),
            ...
            s = e;
          return 0 === e.type.indexOf("MSPointer") && (a = !0), o && (n = e.changedTouches[0].pageX, r = e.changedTouches[0].pageY), t = t || p(), (i || a) && (n = e.clientX + t.x, r = e.clientY + t.y), s.pageOffset = t, s.points = [n, r], s.cursor = i || a, s
        }
        ...
        function w() {
          ...
          var e = X.map(C);
          r.dir && (e.reverse(), r.tooltips.reverse()), $("update", function(t, n, o) {
        ...
        function P(t, n, r) {
          ...
          var i = te.direction,
            ...
            c = !1,
            f = 0;
          return te.direction = 0, r = e(r.slice().sort(function(e, t) {
            return e - t
          })), r[0] !== s && (r.unshift(s), l = !0), r[r.length - 1] !== u && (r.push(u), c = !0), r.forEach(function(e, i) {
            var s, u, p, d, h, m, v, g, y, b, _ = e,
              C = r[i + 1];
            if ("steps" === n && (s = te.xNumSteps[i]), s || (s = C - _), _ !== !1 && void 0 !== C)
              for (u = _; C >= u; u = o(u, s)) {
                for (d = te.toStepping(u), h = d - f, g = h / t, y = Math.round(g), b = h / y, p = 1; y >= p; p += 1) m = f + p * b, a[m.toFixed(5)] = ["x", 0];
                v = r.indexOf(u) > -1 ? 1 : "steps" === n ? 2 : 0, !i && l && (v = 0), u === C && c || (a[d.toFixed(5)] = [u, v]), f = d
              }
          }), te.direction = i, a
        }
        ...
        function E(e, t, n) {
          ...
          function a(e, r) {
            te.direction && (e = 100 - e), r[1] = r[1] && t ? t(r[0], r[1]) : r[1], c += "<div " + i(e, oe[21], r) + "></div>", r[1] && (c += "<div " + i(e, oe[22], r) + ">" + n.to(r[0]) + "</div>")
          }
          var s = ["horizontal", "vertical"][r.ort],
            u = document.createElement("div"),
            c = "";
          return l(u, oe[20]), l(u, oe[20] + "-" + s), Object.keys(e).forEach(function(t) {
            a(t, e[t])
          }), u.innerHTML = c, u
        }
        ...
        function O(e, t, n) {
          void 0 !== t && 1 !== r.handles && (t = Math.abs(t - r.dir)), Object.keys(re).forEach(function(r) {
            var o = r.split(".")[0];
            e === o && re[r].forEach(function(e) {
              e.call(J, s(B()), t, s(T(Array.prototype.slice.call(ne))), n || !1, ee)
            })
          })
        }
        ...
        function k(e, t, n, o) {
          var i = function(t) {
              return Z.hasAttribute("disabled") ? !1 : f(Z, oe[14]) ? !1 : (t = v(t, o.pageOffset), e === W.start && void 0 !== t.buttons && t.buttons > 1 ? !1 : o.hover && t.buttons ? !1 : (t.calcPoint = t.points[r.ort], void n(t, o)))
            },
            a = [];
        ...
        function N(e, t) {
          ...
          var n, r, i = t.handles || X,
            ...
            u = i[0] === X[0] ? 0 : 1;
          if (n = o(s, t.positions, i.length > 1), a = U(i[0], n[u], 1 === i.length), i.length > 1) {
        ...
        function j(e, t) {
          ...
          null !== n && c(n, oe[15]), e.cursor && (document.body.style.cursor = "", document.body.removeEventListener("selectstart", document.body.noUiListener));
          var o = document.documentElement;
          o.noUiListeners.forEach(function(e) {
            o.removeEventListener(e[0], e[1])
          }), c(Z, oe[12]), O("set", r), O("change", r), void 0 !== t.handleNumber && O("end", t.handleNumber)
        }
        ...
        function M(e, t) {
          ...
          if (1 === t.handles.length && (l(t.handles[0].children[0], oe[15]), t.handles[0].hasAttribute("disabled"))) return !1;
          ...
          if (n.noUiListeners = r.concat(o, i), e.cursor) {
            document.body.style.cursor = getComputedStyle(e.target).cursor, X.length > 1 && l(Z, oe[12]);
            var a = function() {
              return !1
            };
        ...
        function F(e) {
          ...
          return e.stopPropagation(), X.forEach(function(e) {
            s += n(e)[r.style]
          }), t = s / 2 > a || 1 === X.length ? 0 : 1, X[t].hasAttribute("disabled") && (t = t ? 0 : 1), a -= n(G)[r.style], o = 100 * a / S(), r.events.snap || i(Z, oe[14], 300), X[t].hasAttribute("disabled") ? !1 : (U(X[t], o), O("slide", t, !0), O("set", t, !0), O("change", t, !0), void(r.events.snap && M(e, {
            handles: [X[t]]
          })))
        }
        ...
        function I(e) {
          ...
          Object.keys(re).forEach(function(e) {
            "hover" === e.split(".")[0] && re[e].forEach(function(e) {
              e.call(J, i)
            })
          })
        }
        ...
        function D(e) {
          var t, n;
          if (!e.fixed)
            for (t = 0; t < X.length; t += 1) k(W.start, X[t].children[0], M, {
              handles: [X[t]],
              handleNumber: t
            });
          ...
          e.drag && (n = [G.querySelector("." + oe[7])], l(n[0], oe[10]), e.fixed && n.push(X[n[0] === X[0] ? 1 : 0].children[0]), n.forEach(function(e) {
            k(W.start, e, M, {
              handles: X
            })
          }))
        ...
        function U(e, t, n) {
          var o = e !== X[0] ? 1 : 0,
            ...
            u = ee[0] + r.limit,
            f = ee[1] - r.limit;
          return X.length > 1 && (t = o ? Math.max(t, i) : Math.min(t, s)), n !== !1 && r.limit && X.length > 1 && (t = o ? Math.min(t, u) : Math.max(t, f)), t = te.getStep(t), t = a(parseFloat(t.toFixed(7))), t === ee[o] ? !1 : (window.requestAnimationFrame ? window.requestAnimationFrame(function() {
            e.style[r.style] = t + "%"
          }) : e.style[r.style] = t + "%", e.previousSibling || (c(e, oe[17]), t > 50 && l(e, oe[17])), ee[o] = t, ne[o] = te.fromStepping(t), O("update", o), !0)
        }

        function L(e, t) {
          var n, o, i;
          for (r.limit && (e += 1), n = 0; e > n; n += 1) o = n % 2, i = t[o], null !== i && i !== !1 && ("number" == typeof i && (i = String(i)), i = r.format.from(i), (i === !1 || isNaN(i) || U(X[o], te.toStepping(i), n === 3 - r.dir) === !1) && O("update", o))
        }

        function H(e) {
          var t, n, o = s(e);
          for (r.dir && r.handles > 1 && o.reverse(), r.animate && -1 !== ee[0] && i(Z, oe[14], 300), t = X.length > 1 ? 3 : 1, 1 === o.length && (t = 1), L(t, o), n = 0; n < X.length; n++) null !== o[n] && O("set", n)
        }

        function B() {
          var e, t = [];
          for (e = 0; e < r.handles; e += 1) t[e] = r.format.to(ne[e]);
          return T(t)
        }
        ...
        function $(e, t) {
          re[e] = re[e] || [], re[e].push(t), "update" === e.split(".")[0] && X.forEach(function(e, t) {
            O("update", t)
          })
        }
        ...
        function Y(e) {
          ...
          for (["margin", "limit", "step", "range", "animate"].forEach(function(t) {
              void 0 !== e[t] && (r[t] = e[t])
            }), o.spectrum.direction = te.direction, te = o.spectrum, ee = [-1, -1], H(n), t = 0; t < X.length; t++) O("update", t)
        }
        m();
        var G, X, J, Z = t,
          ee = [-1, -1],
        ...
        return G = _(r.dir, r.ort, Z), X = b(r.handles, r.dir, G), y(r.connect, Z, X), r.pips && R(r.pips), r.tooltips && w(), J = {
          destroy: q,
          steps: Q,
          on: $,
          off: z,
      ...
      R.prototype.getMargin = function(e) {
        ...
        return e = C(this.xVal, this.xPct, e), this.direction && (e = 100 - e), e
    ...
    function o() {
      ...
      return {
        init: function(e) {
          ...
          if (!o) throw new Error("[sortBySelector]: Index " + r + " not present in `indices`");
    ...
    function o(e) {
      ...
      if (R === !0 && (O = (0, d["default"])(O)), !t || !n) throw new Error(x);
      var T = {
        ...
        disabledLink: (0, f["default"])(w("link", "disabled"), s.disabledLink),
      ...
      return {
        ...
        render: function(e) {
          ...
          for (var r = e.helper, a = e.results, s = e.state, l = e.createURL, c = [], f = {}, d = o - 1; d >= 0; --d) f[d] = 0;
    ...
    function o() {
      ...
      if (a === !0 && (w = (0, f["default"])(w)), !y) throw new Error(C);
      var x = {
    ...
    function o() {
      ...
      if (E === !0 && (S = (0, m["default"])(S)), !t || !n || !r) throw new Error(x);
      var O = void 0 !== a.off,
        T = {
      ...
      return {
        ...
        init: function(e) {
          ...
          if (this._templateProps = (0, f.prepareTemplateProps)({
              ...
              templatesConfig: o,
              templates: l
            }), this.toggleRefinement = this.toggleRefinement.bind(this, r), void 0 !== a.off) {
        ...
        toggleRefinement: function(e, t, r) {
          var o = a.on,
            i = a.off;
          r ? (e.removeFacetRefinement(n, o), O && e.addFacetRefinement(n, i)) : (O && e.removeFacetRefinement(n, i), e.addFacetRefinement(n, o)), e.search()
        },
        render: function(e) {
          function t() {
